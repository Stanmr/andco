...
class EltdfInstagramApi {
    ...
    private $apiURL;
    /**
     * @var EltdfInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var EltdfInstagramHelper
     */
    private $helper;
    ...
    private function __construct() {
        ...
        $this->helper = new EltdfInstagramHelper();
    }
     ...
     * @return string
     *
     * @see EltdfInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see EltdfInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see EltdfInstagramApi::getAccessToken()
     */
