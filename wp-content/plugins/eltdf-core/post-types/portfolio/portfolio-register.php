<?php
namespace EltdCore\CPT\Portfolio;

use EltdCore\Lib\PostTypeInterface;

/**
 * Class PortfolioRegister
 * @package EltdCore\CPT\Portfolio
 */
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $azalea_eltdf_Framework, $azalea_eltdf_options;
        ...
        if(eltdf_core_theme_installed()) {
            $menuPosition = $azalea_eltdf_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $azalea_eltdf_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($azalea_eltdf_options['portfolio_single_slug'])) {
                if($azalea_eltdf_options['portfolio_single_slug'] != ""){
                    $slug = $azalea_eltdf_options['portfolio_single_slug'];
                }
            }
        }
