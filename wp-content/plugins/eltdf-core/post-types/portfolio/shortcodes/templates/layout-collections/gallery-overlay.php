...
<div class="eltdf-pli-text-holder" <?php azalea_eltdf_inline_style($overlay_color); ?>>
	<div class="eltdf-pli-text-wrapper">
		<div class="eltdf-pli-text">
			...
			<div class="eltdf-pli-info-holder">
				...
				<?php echo eltdf_core_get_cpt_shortcode_module_template_part('portfolio', 'parts/images-count', $item_style, $params); ?>

				<?php echo eltdf_core_get_cpt_shortcode_module_template_part('portfolio', 'parts/like', $item_style, $params); ?>
			</div>
