<?php
namespace EltdCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
				    ...
				    'params'                    => array(
					    array(
						    ...
						    'value'       => array(
							    ...
							    esc_html__( 'Justified Gallery', 'eltdf-core' ) => 'justified-gallery'
						    ),
						    'save_always' => true,
						    'admin_label' => true
					    ),
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Row Height', 'eltdf-core' ),
                            'description' => esc_html__( 'Targeted row height, which may vary depending on the proportions of the images.', 'eltdf-core' ),
                            'value'       => '',
					    ...
					    array(
						    ...
						    'value'       => array(
							    ...
							    esc_html__( 'Standard - Image Scale', 'eltdf-core' )            => 'standard-image-scale',
							    esc_html__( 'Gallery - Overlay', 'eltdf-core' )                 => 'gallery-overlay',
							    esc_html__( 'Gallery - Overlay Centered', 'eltdf-core' )        => 'gallery-overlay-centered',
							    esc_html__( 'Gallery - Indented Overlay', 'eltdf-core' )        => 'gallery-indented-overlay',
						...
						array(
							...
							'heading'    => esc_html__( 'Overlay Color', 'eltdf-core' ),
							'group'      => esc_html__( 'Content Layout', 'eltdf-core' ),
							'dependency'  => array('element' => 'item_style', 'value' => array( 'gallery-overlay', 'gallery-indented-overlay'))
						),
					    array(
						    'type'       => 'dropdown',
					    ...
					    array(
						    ...
						    'value'       => array_flip(azalea_eltdf_get_text_transform_array(true)),
						    'dependency'  => array( 'element' => 'enable_title', 'value' => array( 'yes' ) ),
						    'group'       => esc_html__( 'Content Layout', 'eltdf-core' )
					    ),
					    array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'enable_like',
							'heading'    => esc_html__( 'Enable Like', 'eltdf-core' ),
							'value'      => array_flip(azalea_eltdf_get_yes_no_select_array(false, true)),
							'group'      => esc_html__( 'Content Layout', 'eltdf-core' )
						),
                        array(
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'enable_article_parallax_animation',
                            'heading'     => esc_html__( 'Enable Article Parallax Animation', 'eltdf-core' ),
                            'value'       => array_flip(azalea_eltdf_get_yes_no_select_array(false)),
                            'dependency'  => array( 'element' => 'item_style', 'value' => array( 'standard-image-scale') ),
                            'description' => esc_html__( 'Note: If this option is enabled, the Enable Article Animation option will not take effect.', 'eltdf-core' ),
                            'group'       => esc_html__( 'Additional Features', 'eltdf-core' )
                        )
				    )
			    )
    ...
    public function render($atts, $content = null) {
        $args = array(
            ...
            'enable_article_parallax_animation'  => 'no',
        ...
        $additional_params['parallax_data'] = $this->getParallaxData($params);
    ...
    */
	...
	public function getHolderData($params, $additional_params){
        ...
        switch($params['space_between_items']):
    ...
    public function getParallaxData($params){
        ...
        if ($params['enable_article_parallax_animation'] == 'yes') {
			$dataString .= 'data-bottom="transform:translateY(10%)" ';
			$dataString .= 'data-center-bottom="transform:translateY(-10%)" ';
        }
    ...
    /**
     * Generates portfolio filter holder classes
     *
     * @param $params
     *
     * @return string
    ...
    public function getFilterHolderClasses($params){
        ...
        $classes[] = $params['type'] === 'justified-gallery' ? 'eltdf-pl-justified-filter' : 'eltdf-pl-regular-filter';
    ...
    */
	public function getHolderClasses($params){
        ...
        if($params['enable_article_parallax_animation'] === 'yes'){
            $classes[] = 'eltdf-gl-parallax-on-scroll';
        }
