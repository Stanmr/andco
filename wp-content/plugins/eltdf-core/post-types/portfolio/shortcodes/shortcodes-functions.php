...
if(!function_exists('eltdf_core_add_portfolio_shortcodes')) {
	function eltdf_core_add_portfolio_shortcodes($shortcodes_class_name) {
		$shortcodes = array(
			'EltdCore\CPT\Shortcodes\Portfolio\PortfolioList',
			'EltdCore\CPT\Shortcodes\Portfolio\PortfolioProjectInfo',
			'EltdCore\CPT\Shortcodes\Portfolio\PortfolioSlider'
		);
