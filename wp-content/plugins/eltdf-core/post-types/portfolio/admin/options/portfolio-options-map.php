...
if ( ! function_exists('azalea_eltdf_portfolio_options_map') ) {
	function azalea_eltdf_portfolio_options_map() {
		...
		$portfolio_gallery_container = azalea_eltdf_add_admin_container(array(
			'parent'          => $panel,
		...
		$portfolio_masonry_container = azalea_eltdf_add_admin_container(array(
			'parent'          => $panel,
		...
		azalea_eltdf_add_admin_field(array(
			...
			$container_navigate_category = azalea_eltdf_add_admin_container(array(
	...
	add_action( 'azalea_eltdf_options_map', 'azalea_eltdf_portfolio_options_map', 17);
}