...
if(!function_exists('eltdf_core_map_portfolio_settings_meta')) {
    function eltdf_core_map_portfolio_settings_meta() {
        $meta_box = azalea_eltdf_add_meta_box(array(
	    ...
	    $gallery_type_meta_container = azalea_eltdf_add_admin_container(
		    array(
			    'parent' => $meta_box,
	    ...
	    $masonry_type_meta_container = azalea_eltdf_add_admin_container(
		    array(
			    'parent' => $meta_box,
    ...
    add_action('azalea_eltdf_meta_boxes_map', 'eltdf_core_map_portfolio_settings_meta', 41);
}