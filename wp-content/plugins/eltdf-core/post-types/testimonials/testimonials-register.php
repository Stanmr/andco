<?php
namespace EltdCore\CPT\Testimonials;

use EltdCore\Lib;

/**
 * Class TestimonialsRegister
 * @package EltdCore\CPT\Testimonials
 */
class TestimonialsRegister implements Lib\PostTypeInterface {
    ...
    private function registerPostType() {
        ...
        if(eltdf_core_theme_installed()) {
            $menuPosition = $azalea_eltdf_Framework->getSkin()->getMenuItemPosition('testimonial');
            $menuIcon = $azalea_eltdf_Framework->getSkin()->getMenuIcon('testimonial');
        }
