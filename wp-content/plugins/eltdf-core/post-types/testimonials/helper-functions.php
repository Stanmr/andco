...
if(!function_exists('eltdf_core_testimonials_meta_box_functions')) {
	...
	add_filter('azalea_eltdf_meta_box_post_types_save', 'eltdf_core_testimonials_meta_box_functions');
	add_filter('azalea_eltdf_meta_box_post_types_remove', 'eltdf_core_testimonials_meta_box_functions');
}

if(!function_exists('eltdf_core_register_testimonials_cpt')) {
	function eltdf_core_register_testimonials_cpt($cpt_class_name) {
		$cpt_class = array(
			'EltdCore\CPT\Testimonials\TestimonialsRegister'
		);
