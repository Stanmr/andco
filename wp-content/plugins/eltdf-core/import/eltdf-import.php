...
class EltdfCoreImport {
    ...
    public function import_options($file){
        $options = $this->file_options($file);
        $result = update_option( 'eltd_options_azalea', $options);
    ...
    function eltdf_admin_import() {
        if (eltdf_core_theme_installed()) {
            ...
            $this->pagehook = add_submenu_page(
                ...
                array($azalea_eltdf_Framework->getSkin(), 'renderImport')
            );

            add_action('admin_print_scripts-'.$this->pagehook, 'azalea_eltdf_enqueue_admin_scripts');
            add_action('admin_print_styles-'.$this->pagehook, 'azalea_eltdf_enqueue_admin_styles');
        }
    }
}