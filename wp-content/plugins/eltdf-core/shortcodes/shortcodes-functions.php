...
if(!function_exists('eltdf_core_load_shortcodes')) {
	function eltdf_core_load_shortcodes() {
		...
		EltdCore\Lib\ShortcodeLoader::getInstance()->load();
	}
...
if ( ! function_exists( 'eltdf_core_add_admin_shortcodes_styles' ) ) {
	...
	add_action( 'azalea_eltdf_admin_scripts_init', 'eltdf_core_add_admin_shortcodes_styles' );
}
...
if ( ! function_exists( 'eltdf_core_add_admin_shortcodes_custom_styles' ) ) {
	...
	add_action( 'azalea_eltdf_admin_scripts_init', 'eltdf_core_add_admin_shortcodes_custom_styles' );
}