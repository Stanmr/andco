<?php
namespace EltdCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
                        array(
                            ...
                            'value'      => array(
                                esc_html__( 'Below Image', 'eltdf-core' ) => 'banner-below',
                                esc_html__( 'Over Image', 'eltdf-core' )    => 'banner'
                            )
                        ),
					    array(
							'type'        => 'attach_image',
	...
	public function render($atts, $content = null) {
		...
		$html = eltdf_core_get_shortcode_module_template_part('templates/'.$params['type'] , 'banner', '', $params);
	...
	private function getTextStyles($params) {
		...
		if (!empty($params['text_font_size'])) {
			$styles[] = 'font-size: '.azalea_eltdf_filter_px($params['text_font_size']).'px';
		}
