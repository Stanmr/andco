<?php
namespace EltdCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Enable Image Info', 'eltdf-core' ),
                            'value'      => array_flip( azalea_eltdf_get_yes_no_select_array( false ) ),
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Enable Auto Width', 'eltdf-core' ),
	...
	private function getGalleryImages($params) {
		...
		foreach ($image_ids as $id) {
			...
			$thumb_img = get_post($id);
			$image['description'] = $thumb_img->post_content;
