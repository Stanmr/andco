...
<div class="eltdf-video-button-holder">
	...
	<?php } else { ?>
		<a class="eltdf-video-button-play" <?php echo azalea_eltdf_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" target="_self" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="eltdf-video-button-play-inner">
