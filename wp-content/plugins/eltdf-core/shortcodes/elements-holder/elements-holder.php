<?php
namespace EltdCore\CPT\Shortcodes\ElementsHolder;
...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . azalea_eltdf_get_class_attribute($elements_holder_class) . ' ' . azalea_eltdf_get_inline_attr($elements_holder_style, 'style'). '>';
