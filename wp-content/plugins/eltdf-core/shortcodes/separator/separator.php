<?php
namespace EltdCore\CPT\Shortcodes\Separator;
...
class Separator implements Lib\ShortcodeInterface {
	...
	private function getSeparatorStyles($params) {
		...
		if ($params['width'] !== '') {
			if(azalea_eltdf_string_ends_with($params['width'], '%') || azalea_eltdf_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(azalea_eltdf_string_ends_with($params['top_margin'], '%') || azalea_eltdf_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(azalea_eltdf_string_ends_with($params['bottom_margin'], '%') || azalea_eltdf_string_ends_with($params['bottom_margin'], 'px')) {
