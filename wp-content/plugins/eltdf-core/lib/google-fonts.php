<?php
if ( ! function_exists( 'azalea_eltdf_init_google_fonts_array' ) ) {
    function azalea_eltdf_init_google_fonts_array() {

        global $azalea_eltdf_fonts_array;
        $azalea_eltdf_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'azalea_eltdf_init_google_fonts_array');
}