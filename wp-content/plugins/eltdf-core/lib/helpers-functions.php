...
if(!function_exists('azalea_eltdf_add_user_custom_fields')) {
	/**
	 * Function creates custom social fields for users
	 *
	 * return $user_contact
	 */
	function azalea_eltdf_add_user_custom_fields($user_contact) {
		/**
	...
	add_filter('user_contactmethods', 'azalea_eltdf_add_user_custom_fields');
}
