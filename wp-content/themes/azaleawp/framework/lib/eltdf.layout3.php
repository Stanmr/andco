...
/*
   Class: AzaleaEltdfMultipleImages
   A class that initializes Elated Multiple Images
*/
class AzaleaEltdfMultipleImages implements iAzaleaEltdfRender {
	private $name;
	private $label;
	private $description;
	...
	function __construct($name,$label="",$description="") {
		...
		$azalea_eltdf_Framework->eltdMetaBoxes->addOption($this->name,"");
	}
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="eltdf-gallery-uploader">
								<a class="eltdf-gallery-upload-btn btn btn-sm btn-primary" href="javascript:void(0)"><?php esc_html_e('Upload', 'azaleawp'); ?></a>
								<a class="eltdf-gallery-clear-btn btn btn-sm btn-default pull-right" href="javascript:void(0)"><?php esc_html_e('Remove All', 'azaleawp'); ?></a>
							</div>
						</div>
					</div>
				</div>
...
/*
   Class: AzaleaEltdfImagesVideos
   A class that initializes Elated Images Videos
*/
class AzaleaEltdfImagesVideos implements iAzaleaEltdfRender {
	private $label;
	private $description;
	...
	public function render($factory) {
			...
			<div class="eltdf-page-form-section">
				...
				<div class="eltdf-section-content">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-2">
								<em class="eltdf-field-description"><?php esc_html_e('Order Number', 'azaleawp'); ?></em>
						...
						<div class="row next-row">
							<div class="col-lg-12">
								<em class="eltdf-field-description"><?php esc_html_e('Image', 'azaleawp'); ?></em>
								<div class="eltdf-media-uploader">
									...
									<a class="eltdf-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="<?php esc_html_e('Select Image', 'azaleawp'); ?>" data-frame-button-text="<?php esc_html_e('Select Image', 'azaleawp'); ?>"><?php esc_html_e('Upload', 'azaleawp'); ?></a>
									<a style="display: none;" href="javascript: void(0)" class="eltdf-media-remove-btn btn btn-default btn-sm"><?php esc_html_e('Remove', 'azaleawp'); ?></a>
								</div>
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-3">
								<em class="eltdf-field-description"><?php esc_html_e('Video Type', 'azaleawp'); ?></em>
								<select class="form-control eltdf-form-element eltdf-portfoliovideotype" name="portfoliovideotype_x" id="portfoliovideotype_x">
									<option value=""></option>
									<option value="youtube"><?php esc_html_e('YouTube', 'azaleawp'); ?></option>
									<option value="vimeo"><?php esc_html_e('Vimeo', 'azaleawp'); ?></option>
									<option value="self"><?php esc_html_e('Self Hosted', 'azaleawp'); ?></option>
								</select>
							</div>
							<div class="col-lg-3">
								<em class="eltdf-field-description"><?php esc_html_e('Video ID', 'azaleawp'); ?></em>
						...
						<div class="row next-row">
							<div class="col-lg-4">
								<em class="eltdf-field-description"><?php esc_html_e('Video mp4', 'azaleawp'); ?></em>
								<input type="text" class="form-control eltdf-input eltdf-form-element" id="portfoliovideomp4_x" name="portfoliovideomp4_x" />
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-12">
								<a class="eltdf_remove_image btn btn-sm btn-primary" href="/" onclick="javascript: return false;"><?php esc_html_e('Remove portfolio image/video', 'azaleawp'); ?></a>
							</div>
						</div>
					</div>
				</div>
		...
		if (count($portfolio_images)>1 && azalea_eltdf_core_plugin_installed()) {
								...
								<div class="col-lg-12">
									...
									<div class="eltdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfolioimg']) == false) { ?> style="display: none"<?php } ?> class="eltdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfolioimg']) == true) { echo esc_url(azalea_eltdf_get_attachment_thumb_url(stripslashes($portfolio_image['portfolioimg']))); } ?>" alt="" class="eltdf-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
							...
							<div class="row next-row">
								<div class="col-lg-3">
									...
									<select class="form-control eltdf-form-element eltdf-portfoliovideotype" name="portfoliovideotype[]" id="portfoliovideotype_<?php echo esc_attr($no); ?>">
										<option value=""></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "youtube") { echo "selected='selected'"; } ?>  value="youtube"><?php esc_html_e('YouTube', 'azaleawp'); ?></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "vimeo") { echo "selected='selected'"; } ?>  value="vimeo"><?php esc_html_e('Vimeo', 'azaleawp'); ?></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "self") { echo "selected='selected'"; } ?>  value="self"><?php esc_html_e('Self Hosted', 'azaleawp'); ?></option>
									</select>
								</div>
								<div class="col-lg-3">
									<em class="eltdf-field-description"><?php esc_html_e('Video ID', 'azaleawp'); ?></em>
								...
								<div class="col-lg-12">
									...
									<div class="eltdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == false) { ?> style="display: none"<?php } ?> class="eltdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == true) { echo esc_url(azalea_eltdf_get_attachment_thumb_url(stripslashes($portfolio_image['portfoliovideoimage']))); } ?>" alt="" class="eltdf-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
		...
		?>
		<br />
		<a class="eltdf_add_image btn btn-sm btn-primary" onclick="javascript: return false;" href="/"><?php esc_html_e('Add portfolio image/video', 'azaleawp'); ?></a>
	<?php
	}
}
...
/*
   ...
   A class that initializes Elated Images Videos
*/
class AzaleaEltdfImagesVideosFramework implements iAzaleaEltdfRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		<div class="eltdf-hidden-portfolio-images"  style="display: none">
			<div class="eltdf-portfolio-toggle-holder">
				<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
					<span class="number">1</span><span class="eltdf-toggle-inner"><?php esc_html_e('Image - ', 'azaleawp'); ?><em><?php esc_html_e('Order Number', 'azaleawp'); ?></em></span>
				</div>
		...
		<div class="eltdf-hidden-portfolio-videos"  style="display: none">
			<div class="eltdf-portfolio-toggle-holder">
				<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
					<span class="number">2</span><span class="eltdf-toggle-inner"><?php esc_html_e('Video - ', 'azaleawp'); ?><em><?php esc_html_e('Order Number', 'azaleawp'); ?></em></span>
				</div>
				<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
					...
					<div class="eltdf-section-content">
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-2">
									<div class="eltdf-media-uploader">
										<em class="eltdf-field-description"><?php esc_html_e('Cover Video Image', 'azaleawp'); ?></em>
										<div style="display: none" class="eltdf-media-image-holder">
											<img src="" alt="" class="eltdf-media-image img-thumbnail">
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
								...
								<div class="col-lg-10">
									...
									<div class="row next-row">
										...
										<div class="col-lg-2 eltdf-video-id-holder">
											<em class="eltdf-field-description" id="videoId"><?php esc_html_e('Video ID', 'azaleawp'); ?></em>
											<input type="text" class="form-control eltdf-input eltdf-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x">
										</div>
									</div>
		...
		while (isset($portfolio_images[$no-1])) {
			...
			if ($portfolio_img_type == "image") {
				...
				<div class="eltdf-portfolio-images eltdf-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="eltdf-portfolio-toggle-holder">
						<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="eltdf-toggle-inner"><?php esc_html_e('Image - ', 'azaleawp'); ?><em><?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?></em></span>
						</div>
						<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
			...
			<?php
				...
				<div class="eltdf-portfolio-videos eltdf-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="eltdf-portfolio-toggle-holder">
						<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="eltdf-toggle-inner"><?php esc_html_e('Video - ', 'azaleawp'); ?><em><?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?></em></span>
						</div>
						<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
		...
		<div class="eltdf-portfolio-add">
			<a class="eltdf-add-image btn btn-sm btn-primary" href="#"><i class="fa fa-camera"></i><?php esc_html_e('Add Image', 'azaleawp'); ?></a>
			<a class="eltdf-add-video btn btn-sm btn-primary" href="#"><i class="fa fa-video-camera"></i><?php esc_html_e('Add Video', 'azaleawp'); ?></a>
			<a class="eltdf-toggle-all-media btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'azaleawp'); ?></a>
		</div>
	<?php
	}
}

class AzaleaEltdfTwitterFramework implements  iAzaleaEltdfRender {
    public function render($factory) {
        ...
        if(!empty($_GET['oauth_token']) && !empty($_GET['oauth_verifier'])) {
            ...
            if($responseObj->status) {
                $message = esc_html__('You have successfully connected with your Twitter account. If you have any issues fetching data from Twitter try reconnecting.', 'azaleawp');
            } else {
                $message = $responseObj->message;
            }
        }

        $buttonText = $twitterApi->hasUserConnected() ? esc_html__('Re-connect with Twitter', 'azaleawp') : esc_html__('Connect with Twitter', 'azaleawp');
    ?>
        <?php if($message !== '') { ?>
        ...
        <div class="eltdf-page-form-section" id="eltdf_enable_social_share">
            <div class="eltdf-field-desc">
                <h4><?php esc_html_e('Connect with Twitter', 'azaleawp'); ?></h4>
                <p><?php esc_html_e('Connecting with Twitter will enable you to show your latest tweets on your site', 'azaleawp'); ?></p>
            </div>
            <div class="eltdf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
class AzaleaEltdfInstagramFramework implements  iAzaleaEltdfRender {
    public function render($factory) {
        $instagram_api = EltdfInstagramApi::getInstance();
        $message = '';
		...
		if(!get_option('eltdf_instagram_code')) {
			...
			if(!empty($_GET['code'])) {
				...
				$message = esc_html__('You have successfully connected with your Instagram account. If you have any issues fetching data from Instagram try reconnecting.', 'azaleawp');
		...
		$buttonText = $instagram_api->hasUserConnected() ? esc_html__('Re-connect with Instagram', 'azaleawp') : esc_html__('Connect with Instagram', 'azaleawp');
    ...
    ?>
        ...
        <div class="eltdf-page-form-section" id="eltdf_enable_social_share">
            <div class="eltdf-field-desc">
                <h4><?php esc_html_e('Connect with Instagram', 'azaleawp'); ?></h4>
                <p><?php esc_html_e('Connecting with Instagram will enable you to show your latest photos on your site', 'azaleawp'); ?></p>
            </div>
            <div class="eltdf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
/*
   ...
   A class that initializes Elated Images Videos
*/
class AzaleaEltdfOptionsFramework implements iAzaleaEltdfRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		<div class="eltdf-portfolio-additional-item-holder" style="display: none">
			<div class="eltdf-portfolio-toggle-holder">
				<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
					<span class="number">1</span><span class="eltdf-toggle-inner">Additional Sidebar Item <em><?php esc_html_e('(Order Number, Item Title)', 'azaleawp'); ?></em></span>
				</div>
				<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
					...
					<div class="eltdf-section-content">
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-lg-10">
									<em class="eltdf-field-description"><?php esc_html_e('Item Title', 'azaleawp'); ?></em>
									<input type="text" class="form-control eltdf-input eltdf-form-element" id="optionLabel_x" name="optionLabel_x">
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="eltdf-field-description"><?php esc_html_e('Item Text', 'azaleawp'); ?></em>
									<textarea class="form-control eltdf-input eltdf-form-element" id="optionValue_x" name="optionValue_x"></textarea>
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="eltdf-field-description"><?php esc_html_e('Enter Full URL for Item Text Link', 'azaleawp'); ?></em>
		...
		if (count($portfolios)>1 && azalea_eltdf_core_plugin_installed()) {
		...
		<div class="eltdf-portfolio-add">
			<a class="eltdf-add-item btn btn-sm btn-primary" href="#"><?php esc_html_e('Add New Item', 'azaleawp'); ?></a>
			<a class="eltdf-toggle-all-item btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'azaleawp'); ?></a>
		</div>
	<?php
	}
}