...
if ( ! function_exists('azalea_eltdf_contact_form_7_options_map') ) {

	function azalea_eltdf_contact_form_7_options_map() {

		azalea_eltdf_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'azaleawp'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = azalea_eltdf_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'azaleawp')
		));

		//Text Typography

		$typography_text_group = azalea_eltdf_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'azaleawp'),
			'description'	=> esc_html__('Setup typography for form elements text', 'azaleawp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = azalea_eltdf_add_admin_row(array(
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'azaleawp'),
		));
		...
		$typography_text_row2 = azalea_eltdf_add_admin_row(array(
		...
		$typography_text_row3 = azalea_eltdf_add_admin_row(array(
		...
		$typography_label_group = azalea_eltdf_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'azaleawp'),
			'description'	=> esc_html__('Setup typography for form elements label', 'azaleawp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = azalea_eltdf_add_admin_row(array(
		...
		$typography_label_row2 = azalea_eltdf_add_admin_row(array(
		...
		$background_border_group = azalea_eltdf_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'azaleawp'),
			'description'	=> esc_html__('Setup form elements background and border style', 'azaleawp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = azalea_eltdf_add_admin_row(array(
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'azaleawp')
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'azaleawp')
		));

		$background_border_row2 = azalea_eltdf_add_admin_row(array(
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'azaleawp'),
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'azaleawp')
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'azaleawp')
		));

		$background_border_row3 = azalea_eltdf_add_admin_row(array(
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'azaleawp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'azaleawp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = azalea_eltdf_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'azaleawp'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = azalea_eltdf_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'azaleawp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'azaleawp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'azaleawp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'azaleawp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = azalea_eltdf_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'azaleawp'),
			'description'	=> esc_html__('Setup form elements margin', 'azaleawp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = azalea_eltdf_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'azaleawp'),
			'description'	=> esc_html__('Enter height for textarea form element', 'azaleawp'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = azalea_eltdf_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'azaleawp'),
			'description'	=> esc_html__('Setup button text typography', 'azaleawp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = azalea_eltdf_add_admin_row(array(
		...
		$button_typography_row2 = azalea_eltdf_add_admin_row(array(
		...
		$button_background_border_group = azalea_eltdf_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'azaleawp'),
			'description'	=> esc_html__('Setup button background and border style', 'azaleawp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = azalea_eltdf_add_admin_row(array(
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'azaleawp')
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'azaleawp')
		));

		$button_background_border_row2 = azalea_eltdf_add_admin_row(array(
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'azaleawp')
		));
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'azaleawp')
		));

		$button_background_border_row3 = azalea_eltdf_add_admin_row(array(
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'azaleawp'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		azalea_eltdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'azaleawp'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = azalea_eltdf_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'azaleawp')
		));
        ...
        $panel_contact_form_style_3 = azalea_eltdf_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'azaleawp')
        ));
        ...
        $typography_label_row3 = azalea_eltdf_add_admin_row(array(
        ...
        $button_typography_row3 = azalea_eltdf_add_admin_row(array(
	...
	add_action( 'azalea_eltdf_options_map', 'azalea_eltdf_contact_form_7_options_map', 20);
}