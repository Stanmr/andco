...
class HeaderCentered extends HeaderType {
	...
	public function __construct() {
		...
		if ( ! is_admin() ) {
			$this->logoAreaHeight     = azalea_eltdf_set_default_logo_height_for_header_types();
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters['logo_area_in_grid'] = azalea_eltdf_get_meta_field_intersect( 'logo_area_in_grid', $id ) == 'yes' ? true : false;
		$parameters['menu_area_in_grid'] = azalea_eltdf_get_meta_field_intersect( 'menu_area_in_grid', $id ) == 'yes' ? true : false;
		
		$parameters = apply_filters( 'azalea_eltdf_header_centered_parameters', $parameters );
	...
	public function calculateHeightOfTransparency() {
		...
		$logo_background_color             = azalea_eltdf_options()->getOptionValue( 'logo_area_background_color' );
		$logo_background_transparency      = azalea_eltdf_options()->getOptionValue( 'logo_area_background_transparency' );
		$logo_grid_background_color        = azalea_eltdf_options()->getOptionValue( 'logo_area_grid_background_color' );
		$logo_grid_background_transparency = azalea_eltdf_options()->getOptionValue( 'logo_area_grid_background_transparency' );
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if ( $logoAreaTransparent || $menuAreaTransparent ) {
			if ( $logoAreaTransparent ) {
				...
				if ( azalea_eltdf_is_top_bar_enabled() && azalea_eltdf_is_top_bar_completely_transparent() ) {
					$transparencyHeight += azalea_eltdf_get_top_bar_height();
				}
			}
