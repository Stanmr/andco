...
<header class="eltdf-page-header">
    ...
    <div class="eltdf-logo-area">
	    <?php do_action( 'azalea_eltdf_after_header_logo_area_html_open' ); ?>
            ...
            <div class="eltdf-vertical-align-containers">
                <div class="eltdf-position-center">
                    <div class="eltdf-position-center-inner">
                        <?php if(!$hide_logo) {
                            azalea_eltdf_get_logo('header-centered');
                        } ?>
                    </div>
                </div>
            </div>
	...
	<?php if($show_sticky) {
		azalea_eltdf_get_sticky_header('centered', 'header/types/header-centered');
	} ?>
