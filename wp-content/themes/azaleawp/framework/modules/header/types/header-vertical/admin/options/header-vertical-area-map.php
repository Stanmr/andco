...
if ( ! function_exists( 'azalea_eltdf_get_hide_dep_for_header_vertical_area_options' ) ) {
	function azalea_eltdf_get_hide_dep_for_header_vertical_area_options() {
		$hide_dep_options = apply_filters( 'azalea_eltdf_header_vertical_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'azalea_eltdf_header_vertical_options_map' ) ) {
	function azalea_eltdf_header_vertical_options_map( $panel_header ) {
		$hide_dep_options = azalea_eltdf_get_hide_dep_for_header_vertical_area_options();
		
		$vertical_area_container = azalea_eltdf_add_admin_container_no_style(
			array(
				'parent'          => $panel_header,
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on vertical header', 'azaleawp' ),
			)
		);
		...
		$vertical_header_shadow_border_container = azalea_eltdf_add_admin_container(
			array(
				'parent'          => $vertical_area_container,
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set border color for vertical area', 'azaleawp' ),
			)
		);
		...
		do_action( 'azalea_eltdf_header_vertical_area_additional_options', $panel_header );
	}
	
	add_action( 'azalea_eltdf_additional_header_menu_area_options_map', 'azalea_eltdf_header_vertical_options_map' );
}