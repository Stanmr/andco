...
if ( ! function_exists( 'azalea_eltdf_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function azalea_eltdf_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'azalea_eltdf_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'azalea_eltdf_header_vertical_navigation_options_map' ) ) {
	function azalea_eltdf_header_vertical_navigation_options_map() {
		$hide_dep_options = azalea_eltdf_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = azalea_eltdf_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'azaleawp' ),
		...
		$drop_down_group = azalea_eltdf_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'azaleawp' )
			)
		);
		
		$vertical_drop_down_row1 = azalea_eltdf_add_admin_row(
			array(
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'azaleawp' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'azaleawp' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		$group_vertical_first_level = azalea_eltdf_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'azaleawp' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'azaleawp' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = azalea_eltdf_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = azalea_eltdf_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = azalea_eltdf_add_admin_row(
			array(
		...
		$group_vertical_second_level = azalea_eltdf_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'azaleawp' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'azaleawp' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = azalea_eltdf_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = azalea_eltdf_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = azalea_eltdf_add_admin_row(
			array(
		...
		$group_vertical_third_level = azalea_eltdf_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'azaleawp' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'azaleawp' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = azalea_eltdf_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = azalea_eltdf_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = azalea_eltdf_add_admin_row(
			array(
	...
	add_action( 'azalea_eltdf_additional_header_main_navigation_options_map', 'azalea_eltdf_header_vertical_navigation_options_map', 10, 1 );
}