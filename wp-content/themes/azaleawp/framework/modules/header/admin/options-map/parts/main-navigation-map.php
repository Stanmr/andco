...
if ( ! function_exists( 'azalea_eltdf_get_hide_dep_for_header_main_menu_options' ) ) {
	function azalea_eltdf_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'azalea_eltdf_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'azalea_eltdf_header_main_navigation_options_map' ) ) {
	function azalea_eltdf_header_main_navigation_options_map() {
		$hide_dep_options = azalea_eltdf_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = azalea_eltdf_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'azaleawp' ),
		...
		azalea_eltdf_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'azaleawp' )
			)
		);
		
		$drop_down_group = azalea_eltdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'azaleawp' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'azaleawp' )
			)
		);
		
		$drop_down_row1 = azalea_eltdf_add_admin_row(
			array(
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'azaleawp' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'azaleawp' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'azaleawp' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'azaleawp' )
				)
			)
		);
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dropdown Position', 'azaleawp' ),
				'description'   => esc_html__( 'Enter value in percentage of entire header height', 'azaleawp' ),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => '%'
				)
		...
		$first_level_group = azalea_eltdf_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'azaleawp' )
			)
		);
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'azaleawp' ),
			)
		);
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'azaleawp' ),
			)
		);
		
		$first_level_row4 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'azaleawp' ),
			)
		);
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'azaleawp' ),
			)
		);
		
		$first_level_row5 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'azaleawp' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'azaleawp' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = azalea_eltdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'azaleawp' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'azaleawp' )
			)
		);
		...
		azalea_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'azaleawp' )
			)
		);
		...
		$second_level_wide_group = azalea_eltdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'azaleawp' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'azaleawp' )
			)
		);
		
		$second_level_wide_row1 = azalea_eltdf_add_admin_row(
			array(
		...
		$second_level_wide_row2 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = azalea_eltdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'azaleawp' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'azaleawp' )
			)
		);
		...
		$third_level_row3 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = azalea_eltdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'azaleawp' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'azaleawp' )
			)
		);
		
		$third_level_wide_row1 = azalea_eltdf_add_admin_row(
			array(
		...
		$third_level_wide_row2 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = azalea_eltdf_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'azalea_eltdf_header_main_navigation_options_map', 'azalea_eltdf_header_main_navigation_options_map', 10, 1 );
}