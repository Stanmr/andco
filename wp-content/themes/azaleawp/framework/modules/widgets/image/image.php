...
class AzaleaEltdfImageWidget extends AzaleaEltdfWidget {
    public function __construct() {
        parent::__construct(
            'eltdf_image_widget',
            esc_html__('Elated Image Widget', 'azaleawp'),
            array( 'description' => esc_html__( 'Add image element to widget areas', 'azaleawp'))
        );
    ...
    protected function setParams() {
        $this->params = array(
            ...
            array(
                'type'  => 'textfield',
                'name'  => 'image_alt',
                'title' => esc_html__('Image Alt', 'azaleawp')
            ),
            array(
                'type'  => 'textfield',
                'name'  => 'image_width',
                'title' => esc_html__('Image Width', 'azaleawp')
            ),
            array(
                'type'  => 'textfield',
                'name'  => 'image_height',
                'title' => esc_html__('Image Height', 'azaleawp')
            ),
            array(
                'type'  => 'textfield',
                'name'  => 'link',
    ...
    public function widget($args, $instance) {
        ...
        $image_src = '';
        $image_alt = esc_html__('Widget Image', 'azaleawp');
        $image_width = '';
        $image_height = '';
