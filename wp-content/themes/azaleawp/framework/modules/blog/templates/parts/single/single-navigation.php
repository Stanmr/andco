<?php
$blog_single_navigation = azalea_eltdf_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = azalea_eltdf_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
		...
		<div class="eltdf-blog-single-navigation-inner clearfix">
			...
			$post_navigation = array(
				'prev' => array(
					...
					'label' => '<span class="eltdf-blog-single-nav-label">'.esc_html__('previous', 'azaleawp').'</span>'
				),
				'next' => array(
					'mark' => '<span class="eltdf-blog-single-nav-mark ion-ios-arrow-thin-right"></span>',
					'label' => '<span class="eltdf-blog-single-nav-label">'.esc_html__('next', 'azaleawp').'</span>'
				)
			);
