...
if( !function_exists('azalea_eltdf_get_blog_holder_classes') ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function azalea_eltdf_get_blog_holder_classes($classes) {
	...
	add_filter( 'azalea_eltdf_blog_holder_classes', 'azalea_eltdf_get_blog_holder_classes' );
}
...
if( !function_exists('azalea_eltdf_blog_part_params') ) {
    function azalea_eltdf_blog_part_params($params) {
        ...
        $part_params['share_type'] = 'font-elegant';
