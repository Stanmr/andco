...
add_filter( 'wp_setup_nav_menu_item', 'azalea_eltdf_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'azalea_eltdf_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'azalea_eltdf_edit_walker', 10, 2 );

function azalea_eltdf_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function azalea_eltdf_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 * @return      void
*/
function azalea_eltdf_edit_walker($walker,$menu_id) {
	return 'AzaleaEltdf_Walker_Nav_Menu_Edit_Custom';
}
