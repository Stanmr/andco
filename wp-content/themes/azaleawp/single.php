...
<?php if (have_posts()) : ?>
    <?php while (have_posts()) : the_post(); ?>
        ...
        $eltdf_blog_single_type = azalea_eltdf_get_blog_single_layout();
        azalea_eltdf_include_blog_helper_functions('singles', $eltdf_blog_single_type);

        //Action added for applying module specific filters that couldn't be applied on init
        do_action('azalea_eltdf_blog_single_loaded');
        ...
        <div class="<?php echo esc_attr($eltdf_holder_params['holder']); ?>">
            ...
            <div class="<?php echo esc_attr($eltdf_holder_params['inner']); ?>">
                <?php azalea_eltdf_get_blog_single($eltdf_blog_single_type); ?>
            </div>
